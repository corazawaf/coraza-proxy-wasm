...
waf_filter_tx_interruptions{phase="http_request_headers",rule_id="101",identifier="default"} 1
waf_filter_tx_interruptions{phase="http_request_body",rule_id="102",identifier="default"} 1
waf_filter_tx_interruptions{phase="http_response_headers",rule_id="103",identifier="default"} 1
waf_filter_tx_interruptions{phase="http_response_body",rule_id="104",identifier="default"} 1
waf_filter_tx_interruptions{phase="http_request_body",rule_id="949110",identifier="default"} 1
waf_filter_tx_interruptions{phase="http_response_headers",rule_id="949110",identifier="default"} 1
waf_filter_tx_interruptions{phase="http_request_headers",rule_id="949111",identifier="default"} 1
