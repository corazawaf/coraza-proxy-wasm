...
go-ftw run -d coreruleset/tests/regression/tests --config ftw.yml --read-timeout=10s --cloud=$FTW_CLOUDMODE -i 920272-5 || (echo "Envoy Logs:" && cat /home/envoy/logs/envoy.log; exit 1)
